FROM docker.io/node:22.14.0-alpine AS builder
...
FROM docker.io/node:22.14.0-alpine AS pandora-server-directory
...
FROM docker.io/node:22.14.0-alpine AS pandora-server-shard
