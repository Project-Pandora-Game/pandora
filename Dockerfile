FROM docker.io/node:22.21.1-alpine AS builder
...
FROM docker.io/node:22.21.1-alpine AS pandora-server-directory
...
FROM docker.io/node:22.21.1-alpine AS pandora-server-shard
