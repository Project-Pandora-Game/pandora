...
export function Eula({ accept }: EulaProps): ReactElement {
	...
	return (
		<>
			<div className='eula center-header'>
				<div className='eula-header'>
					<img src={ pandoraLogo } alt={ 'Pandora Logo' } width={ '407em' } height={ '100em' } />
					<p />
				</div>
				...
				<Row className='eula-buttons' alignX='space-evenly'>
		...
		<ModalDialog>
			<div className='policyDetails'>
				<div>
					...
					<ul>
						<li>Using our Official Discord server: <a href='https://discord.gg/SHJMjEh9VH' rel='external nofollow noopener' target='_blank'>https://discord.gg/SHJMjEh9VH</a></li>
					</ul>
				</div>
			</div>
			<Row className='policyDetails-button' alignX='center'>
