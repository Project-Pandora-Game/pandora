...
const TEASER_CONTENTS: [string, string][] = [
	...
	['Enhance the scene with adjustable posing in interconnected rooms that can be customized with items and decorations.', 'preview_4.png'],
	[`${ GAME_NAME } is a free open-source licensed roleplaying platform. Feel invited to help building it up further.`, 'preview_5.png'],
];
