...
import { useCharacterState, useGameStateOptional, useGlobalState, useSpaceCharacters } from '../../services/gameLogic/gameStateHooks.ts';
...
import { GameState } from '../gameContext/gameStateContextProvider.tsx';
