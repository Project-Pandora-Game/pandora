...
import { CHARACTER_MOVEMENT_TRANSITION_DURATION_MANIPULATION } from '../../graphics/room/roomCharacter.tsx';
import { useRoomCharacterOffsets, useRoomCharacterPosition } from '../../graphics/room/roomCharacterPosition.ts';
