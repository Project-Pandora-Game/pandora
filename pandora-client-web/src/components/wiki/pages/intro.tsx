	...
	return (
		<>
			...
			<ul>
				...
				<li>You can whisper to multiple people at the same time, by adding them through the character context menu, or by holding <kbd>Ctrl</kbd> while clicking names in the chat.</li>
