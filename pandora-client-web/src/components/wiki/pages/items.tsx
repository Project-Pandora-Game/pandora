	...
	return (
		<>
			...
			<p>
				...
				other item or in a <a href='/wiki/items/#RO_Room_inventory'>room's inventory</a>, which could be considered the room's floor.<br />
			...
			<p>
				...
				Only the base shape of the body needs to remain the same due to the pose transformations.<br />
			...
			<p>
				...
				They first need to be created in the <a href='/wiki/items/#RO_Room_inventory'>room inventory</a> and then deployed into the room with the according button,
				after clicking on them in the inventory list.<br />
			...
			<p>
				After clicking on an item with a storage module in the <a href='/wiki/items/#CH_Character_wardrobe'>wardrobe</a>, the inventory view of the
			...
			<ul>
				...
				<li>
					...
					even while it was stored somewhere else, e.g. in a <a href='/wiki/items/#RO_Room_inventory'>room's inventory</a>, in the meantime.
				</li>
			</ul>

			<h4 id='IT_Item_preferences_and_limits'>Item preferences and limits</h4>
			<p>
				With the "Item Limits"-tab in the <a href='/wiki/items/#CH_Character_wardrobe'>wardrobe</a>, you can set preferences for individual
			...
			<p>
				...
				The layering order of items is that the higher an item is in the <a href='/wiki/items/#CH_Character_wardrobe'>character wardrobe</a> list,
				...
				You add and remove outfits worn on by the character from top to bottom, so from the outermost worn item (e.g. a jacket or dress)
				towards the inner pieces, like how you would undress in reality, too.<br />
				In case you dropped items in that manner to the <a href='/wiki/items/#RO_Room_inventory'>room inventory</a>, you can again add them to the body from the top to bottom,
			...
			<p>
				...
				in the <a href='/wiki/items/#CH_Character_wardrobe'>character wardrobe</a> wear order. Currently, not many assets use alpha masks, as the performance impact is too
