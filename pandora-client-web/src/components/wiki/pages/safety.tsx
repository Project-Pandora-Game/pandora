...
export function WikiSafety(): ReactElement {
	return (
		<>
			...
			<p>
				Some items might not be removable by everyone (for example password locks). By default these items require additional permissions
				to be used. The decision whether to allow someone to use them or not is left to users, letting everyone choose if they are
				comfortable with such item being used and trust the person using them.
