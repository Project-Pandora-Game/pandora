	...
	return (
		<>
			<div>
				...
				>
					...
					<ContextHelpButton>
						...
						<p>
							...
							there is a setting 'colorization' specifies colors the asset uses.
						</p>
						<p>
							To prevent this layer from being colorable, set the value to an empty string.
						</p>
						<p>
				...
				<datalist id='layer-colorization-list'>
					{ Object.keys(colorization).map((key) => (
						<option key={ key } value={ key } />
					)) }
				</datalist>
				<input
					id='layer-colorization'
					list='layer-colorization-list'
					type='text'
					value={ value }
					onChange={ onChange }
					className='flex-1'
			...
			<div>
				...
				>
					...
					<ContextHelpButton>
						...
						<p>
							If the colorization definition also has a control group,<br />
							it will be shown here. If the color group is active, then this layer<br />
							will inherit the color of another item with the same color group.
						</p>
						<p>
