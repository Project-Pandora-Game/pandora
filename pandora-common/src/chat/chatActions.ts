const CHAT_ACTIONS_DEF = {
	...
	gamblingDeckCreation: `SOURCE_CHARACTER created a game of crads. Use 'join' to join the game.`,
	gamblingDeckNoGame: `You have to 'create' a game first, before you can play.`,
	gamblingDeckJoined: 'SOURCE_CHARACTER joins the game.',
	gamblingDeckJoinedAlready: 'You are already part of this game.',
