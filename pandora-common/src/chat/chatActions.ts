const CHAT_ACTIONS_DEF = {
	...
	// Room & space changes
	roomConfigureBackground: `SOURCE_CHARACTER changed room background.`,
	roomConfigureName: `SOURCE_CHARACTER changed room name.`,
	spaceLayoutChange: `SOURCE_CHARACTER changed the space's layout.`,
	...
	gamblingCardGameCreation: `SOURCE_CHARACTER created a game of cards. Use 'join' to join the game.`,
	...
	gamblingCardGameJoined: 'SOURCE_CHARACTER joins the game hosted by DEALER.',
	...
	gamblingCardGamePlayerCheck: 'PLAYER has revealed HAND.',
