...
/** The maximum length of a password (not yet used) */
export const LIMIT_PASSWORD_LENGTH = 256;

/** The maximum length of a room's name */
export const LIMIT_ROOM_NAME_LENGTH = 40;

/** The maximum length of a room's description */
export const LIMIT_ROOM_DESCRIPTION_LENGTH = 10000;

/** The maximum length of a chat message */
export const LIMIT_CHAT_MESSAGE_LENGTH = 5000;
 ...
 */
export const LIMIT_DIRECT_MESSAGE_LENGTH = 5000;
