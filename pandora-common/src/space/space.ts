...
import { LIMIT_SPACE_DESCRIPTION_LENGTH, LIMIT_SPACE_FLUFFTEXT_LENGTH, LIMIT_SPACE_MAX_CHARACTER_NUMBER, LIMIT_SPACE_NAME_LENGTH, LIMIT_SPACE_NAME_PATTERN } from '../inputLimits';
...
export const SpaceBaseInfoSchema = z.object({
	...
	fluffText: z.string().max(LIMIT_SPACE_FLUFFTEXT_LENGTH),
